...
**Primary collections:** `users`, `roles`, `permissions`, `refresh_tokens`, `otp_verifications`, `password_reset_tokens`
**Note:** Owns MFA enforcement for STAFF/ADMIN (v1.1 remediation, docs/02 §9.1).
