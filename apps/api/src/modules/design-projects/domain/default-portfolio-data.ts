import { IPortfolioProject } from './portfolio.types';

export const DEFAULT_PORTFOLIO_PROJECTS: Omit<IPortfolioProject, '_id' | 'id'>[] = [
  {
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-160058515526-990dced4db0d?q=80&w=1200&auto=format&fit=crop',
    galleryImages: [
      'https://images.unsplash.com/photo-160058515526-990dced4db0d?q=80&w=1200&auto=format&fit=crop',
