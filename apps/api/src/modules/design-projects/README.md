...
**Primary collections:** `design_projects`, `design_project_assets`, `portfolios`, `consultations`, `appointments`
**Note:** Owns the state machine (docs/02 §13); business priority #1.
