      ...
      <div className="animate-in fade-in grid gap-6 duration-300">
        <form onSubmit={onMfaSubmit} className="space-y-5">
          ...
          {mfaState === 'MFA_REQUIRED' && (
            <div className="flex items-center gap-3 rounded-2xl border border-amber-500/25 bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-transparent p-3.5 text-left">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-amber-500/30 bg-gradient-to-br from-[#171717] to-[#30170A] text-[#F5A060] shadow-sm">
              ...
              <div>
                ...
                <p className="mt-0.5 text-[11px] text-stone-500">
                  Enter the 6-digit authentication token generated by your authenticator app.
                </p>
              </div>
            </div>
          )}
