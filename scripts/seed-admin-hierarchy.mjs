...
const SYSTEM_PERMISSIONS = [
  ...
  // Design Projects
  { key: 'design-projects.read', module: 'design-projects', description: 'View turnkey interior projects, 3D proposals, and design briefs' },
...
async function seed() {
  ...
  for (const r of ROLES) {
    ...
    console.log(`  ✓ Role: ${r.name} (${pIds.length} permissions) -> ID: ${roleId}`);
  }
  ...
  const USERS_TO_SEED = [
    ...
    // Also update existing dev aliases to Super Admin with the standard password
    {
