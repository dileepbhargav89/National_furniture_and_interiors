...
export const authValidation = {
  ...
  phoneSchema: z
    ...
    .regex(
      /^[\+]?[(]?[0-9]{1,4}[)]?[-\s\./0-9]{7,15}$/,
      'Please enter a valid phone number (e.g. 9109059791 or +919109059791)',
    )
    .max(20),
  registerSchema: z
    .object({
...
export type ForgotPasswordFormData = z.infer<typeof authValidation.forgotPasswordSchema>;
export type ResetPasswordFormData = z.infer<typeof authValidation.resetPasswordSchema>;
